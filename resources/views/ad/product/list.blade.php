...
@section('content')
<h4 class="header-title mb-4">Danh sách Sản Phẩm</h4>
...
<script>
  function del(id,name)
  {
      ...
      document.getElementById("urldelte").href = "ad/product/del/"+id;
  }
</script>
