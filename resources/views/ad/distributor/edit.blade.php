...
@section('content')
<h4 class="header-title mb-4">SỬA NHÀ PHÂN PHỐI</h4>

<form action="ad/distributor/edit/{{$p->id}}" method="POST" class="parsley-examples" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-10">
            ...
            @foreach ($p->images as $i)
                ...
                width="100px" src="distributor/{{$i->img}}" alt="">
            @endforeach
            </div>
        </div>
    </div>
