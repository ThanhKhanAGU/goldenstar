...
@section('content')
<h4 class="header-title mb-4">THÊM HOẠT ĐÔNG</h4>

<form action="ad/action/add" method="POST" class="parsley-examples" enctype="multipart/form-data">
    @csrf
